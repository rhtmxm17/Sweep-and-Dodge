...
| 8 | 런 타임라인 디렉터 (스테이지 2~3분, 캠페인 15~20분 페이싱) | P1 | 4 | 14% | TODO | 0% | 착수 전 | 2026-02-20 |
...
8. 런 타임라인 디렉터: 스테이지당 2~3분 구간을 연결해 무실패 기준 15~20분 캠페인의 난이도 곡선(구간, 피크, 휴식)을 시간축으로 일관되게 관리한다.
