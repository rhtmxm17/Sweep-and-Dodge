...
이 폴더는 `Sweep and Dodge`의 공개 포트폴리오 문장을 뒷받침하는 상세 근거와 해석 경계를 보존한다. 채용 독자를 위한 핵심 서사는 상위 `PORT-*` 문서에 두고, 이 폴더의 자료는 수치·판단·제한을 더 깊게 확인할 때 사용한다.
...
- [PORT-NOTE-001-developer-perspective-and-claim-evidence.md](PORT-NOTE-001-developer-perspective-and-claim-evidence.md): 개발자 관점, 역할 분담, 주장–근거–노출 수준의 원천 노트
- [PORT-NOTE-002-stage2-standalone-profiling-evidence.md](PORT-NOTE-002-stage2-standalone-profiling-evidence.md): Stage 2 standalone profiling의 원시 근거와 해석 경계
