    ...
    public class BulletCollectedSecondaryReactionTests
    {
        ...
        public void VacuumCollectedSecondary_EndToEnd_AppendsDespawnsAndSpawnsSecondaryBullets()
        {
            ...
            try
            {
                ...
                var lifecycleRequest = em.GetComponentData<BulletLifecycleRequestComponent>(collectedBullet);
                Assert.That(lifecycleRequest.Reason, Is.EqualTo(BulletLifecycleReasonId.VacuumCollected));
