...
namespace SweepNDodge.DotsBullets.Tests
{
    public class ContentValidationRulesTests
    {
        ...
        [Test]
        public void SourceTemplate_DuplicateHazardActorIds_IsError()
        {
            var sourceRoot = new GameObject("source_root");
            var sourceAuthoring = sourceRoot.AddComponent<SourceRuntimeTemplateAuthoring>();
            var actorA = new GameObject("actor_a");
            var actorB = new GameObject("actor_b");

            try
            {
                actorA.transform.SetParent(sourceRoot.transform, false);
                actorB.transform.SetParent(sourceRoot.transform, false);
                actorA.AddComponent<HazardActorAuthoring>().ActorId = 1;
                actorB.AddComponent<HazardActorAuthoring>().ActorId = 1;
        ...
        [Test]
        public void SourceTemplate_DuplicateHazardEmitterIdsUnderActor_IsError()
        {
            var sourceRoot = new GameObject("source_root");
            var sourceAuthoring = sourceRoot.AddComponent<SourceRuntimeTemplateAuthoring>();
            var actorGo = new GameObject("actor");
            var emitterA = new GameObject("emitter_a");
            var emitterB = new GameObject("emitter_b");

            try
            {
                actorGo.transform.SetParent(sourceRoot.transform, false);
                emitterA.transform.SetParent(actorGo.transform, false);
                emitterB.transform.SetParent(actorGo.transform, false);
                actorGo.AddComponent<HazardActorAuthoring>().ActorId = 1;
                emitterA.AddComponent<HazardEmitterAuthoring>().EmitterId = 1;
                emitterB.AddComponent<HazardEmitterAuthoring>().EmitterId = 1;
                ...
                var issues = ContentValidationRules.Validate(input);
                Assert.That(issues.Any(i => i.Code == "CV043"), Is.True);
            }
            finally
            {
                Object.DestroyImmediate(sourceRoot);
        ...
        [Test]
        public void SourceTemplate_HazardEmitterWithoutActorParent_IsError()
        {
            var sourceRoot = new GameObject("source_root");
            var sourceAuthoring = sourceRoot.AddComponent<SourceRuntimeTemplateAuthoring>();
            ...
            try
            {
                emitterGo.transform.SetParent(sourceRoot.transform, false);
                emitterGo.AddComponent<HazardEmitterAuthoring>().EmitterId = 1;
                ...
                var issues = ContentValidationRules.Validate(input);
                Assert.That(issues.Any(i => i.Code == "CV044"), Is.True);
            }
            finally
            {
                Object.DestroyImmediate(sourceRoot);
        ...
        [Test]
        public void SourceTemplate_HazardActorInvalidPhaseSelectorPolicy_IsError()
        {
            var sourceRoot = new GameObject("source_root");
            var sourceAuthoring = sourceRoot.AddComponent<SourceRuntimeTemplateAuthoring>();
            var actorGo = new GameObject("actor");
            ...
            try
            {
                bullet.Editor_SetDefinitionId(2201);
                ...
                var issues = ContentValidationRules.Validate(input);
                Assert.That(issues.Any(i => i.Code == "CV091"), Is.True);
            }
            finally
            {
                Object.DestroyImmediate(sourceRoot);
