...
namespace SweepNDodge.DotsBullets
{
    public class BulletSourceAuthoring : MonoBehaviour
    {
        ...
        [Header("Source Definition (Deprecated)")]
        ...
        private class Baker : Baker<BulletSourceAuthoring>
        {
            public override void Bake(BulletSourceAuthoring authoring)
            {
                ...
                AddComponent(e, new SourceStableIdComponent { Value = stableId });
                ...
                AddComponent(e, new SourceSpawnRuntimeComponent { SpawnSequence = 1u });
                ...
                AddBuffer<SourceActiveBulletCountBuffer>(e).Clear();
                AddBuffer<SourceSpawnRequestBuffer>(e).Clear();
                AddBuffer<SourceClipPatternBuffer>(e).Clear();
                AddBuffer<SourceSustainSlotCandidateBuffer>(e).Clear();
                AddBuffer<SourceSustainRuntimeLaneBuffer>(e).Clear();
                AddBuffer<SourceEventQueueBuffer>(e).Clear();
